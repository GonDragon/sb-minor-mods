CarpetColor = WeaponAbility:new()

function CarpetColor:init()
...
function CarpetColor:update(dt, fireMode, shiftHeld)
...
function CarpetColor:adaptAbility()
